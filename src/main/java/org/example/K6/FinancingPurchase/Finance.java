package org.example.K6.FinancingPurchase;

//        The description is rather long but it tries to explain what a financing plan is.
//        The fixed monthly payment for a fixed rate mortgage is the amount paid by the borrower every month
//        that ensures that the loan is paid off in full with interest at the end of its term.
//
...
//        due for the balance of the given month, the second part repays the balance
//        (let us call this part princ) hence for the following month we get a new balance = old balance - princ with c = int + princ.
//
//        Loans are structured so that the amount of principal returned to the borrower starts out small
//        and increases with each mortgage payment. While the mortgage payments in the first years consist primarily of interest payments,
...
//        The partial amortization schedule below shows with 2 decimal floats the balance between principal and interest payments.
//
